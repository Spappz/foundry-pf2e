import { FormDataExtended } from "./../../../../../foundry/client/applications/ux/_module.mjs";
declare const PrototypeTokenConfigPF2e_base: ((abstract new (...args: any[]) => (abstract new (...args: any[]) => {
    ...
    typeof fa.sheets.PrototypeTokenConfig;
declare class PrototypeTokenConfigPF2e extends PrototypeTokenConfigPF2e_base {
    _processFormData(event: SubmitEvent, form: HTMLFormElement, formData: FormDataExtended): Record<string, unknown>;
