declare const CompendiumBrowserSettingsApp_base: ((abstract new (...args: any[]) => {
...
declare class CompendiumBrowserSettingsApp extends CompendiumBrowserSettingsApp_base {
    ...
    tabGroups: Record<string, string>;
    _preFirstRender(context: Record<string, unknown>, options: fa.ApplicationRenderOptions): Promise<void>;
    _attachPartListeners(partId: string, html: HTMLElement, options: fa.api.HandlebarsRenderOptions): void;
    _prepareContext(_options: fa.api.HandlebarsRenderOptions): Promise<object>;
}
