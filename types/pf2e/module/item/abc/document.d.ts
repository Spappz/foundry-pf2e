...
import { AncestrySource, AncestrySystemData } from "@item/ancestry/data.ts";
import { BackgroundSource, BackgroundSystemData } from "@item/background/data.ts";
import { ClassSource, ClassSystemData } from "@item/class/data.ts";
...
declare abstract class ABCItemPF2e<TParent extends ActorPF2e | null> extends ItemPF2e<TParent> {
    ...
    createGrantedItems(options?: { level?: number }): Promise<FeatPF2e<null>[]>;
